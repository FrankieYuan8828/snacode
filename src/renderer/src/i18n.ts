...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "feedback.report.piDesktop": "- Snacode: {value}",
  ...
  "settings.piUpdate": "Snacode CLI 更新",
  "settings.piUpdateDesc": "先检测当前与最新版本，有新版本时才执行更新。",
  "settings.checkPiUpdate": "检查 CLI 更新",
  "settings.piUpdateVersions": "当前：{current} · 最新：{latest}",
  "settings.updatePi": "更新 Agent CLI",
  "settings.piUpdateDone": "CLI 更新命令已完成",
  "settings.piUpdateChecked": "CLI 已是最新版本",
  "settings.piUpdateAvailable": "发现 CLI 新版本",
  "settings.piUpdateStartupNotice": "检测到 CLI 不是最新版本，部分功能可能与低版本不兼容。请到设置里手动更新 CLI。",
  "settings.piUpdateFailed": "Agent CLI 更新失败：{error}",
  ...
  "settings.wsl.piDetected": "Agent CLI 已安装：{version}",
  "settings.wsl.piNotInstalled": "Agent CLI 未安装，请在 WSL 中运行 npm i -g @earendil-works/pi",
  "settings.piUpdateSection": "Agent CLI 更新",
  "settings.piUpdateSectionDesc": "先检测当前与最新版本，有新版本时才执行更新。",
  "settings.piUpdateStatus": "当前：{current} · 最新：{latest}",
  "settings.piUpdateSuccess": "Agent CLI 更新成功",
...
"config.emptyExtensions": "No installed extensions.",
  ...
  "settings.piUpdate": "Snacode CLI Update",
  "settings.piUpdateDesc": "Check current/latest versions first, then update only when a newer version exists.",
  "settings.checkPiUpdate": "Check Agent CLI Update",
  "settings.piUpdateVersions": "Current: {current} · Latest: {latest}",
  "settings.updatePi": "Update Agent CLI",
  "settings.piUpdateDone": "Agent CLI update command completed",
  "settings.piUpdateChecked": "Agent CLI is already up to date",
  "settings.piUpdateAvailable": "New Agent CLI version available",
  "settings.piUpdateStartupNotice": "Agent CLI is not up to date. Some features may be incompatible with older versions. Please update Agent CLI manually in Settings.",
  "settings.piUpdateFailed": "Agent CLI update failed: {error}",
  ...
  "settings.piVersion": "Agent CLI Version",
  "settings.notDetected": "Agent CLI not found",
  "settings.checkPi": "Check Agent CLI",
  ...
  "settings.piSource.label": "Agent CLI Source",
  "settings.piSource.desc": "Choose to use Agent CLI from Windows or from a WSL distribution.",
  "settings.piSource.windows": "Windows — use local Agent CLI",
  "settings.piSource.wsl": "WSL — use Agent CLI from WSL distro",
  ...
  "settings.wsl.piDetected": "Agent CLI installed: {version}",
  "settings.wsl.piNotInstalled": "Agent CLI not installed, run npm i -g @earendil-works/pi in WSL",
  "settings.piUpdateSection": "Agent CLI Update",
  ...
  "settings.piUpdateSuccess": "Agent CLI updated successfully",
