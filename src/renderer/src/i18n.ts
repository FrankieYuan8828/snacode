...
const zhCN = {
  ...
  "mem.card.organizePrompt": "请帮我整理记忆库，读取 ~/.sd/agent/memory-store.json，分析其中的记忆条目：清理重复、合并相近、删除临时状态信息。\n\n规则：\n1. 只输出分析报告，不要调用任何工具\n2. 不要提问，不要确认，直接输出报告\n3. 用户会根据你的报告在界面上自行操作",
  "mem.time.never": "从未",
  "mem.time.today": "今天",
  ...
  "app.emptySubtitle": "Snacode is a minimal agent harness.\nAdapt Snacode to your workflows, not the other way around.",
  "app.terminal": "终端",
  ...
  "app.agentCreateTimeout": "Agent 启动超时，请检查 sd 是否能正常启动，或稍后重试。",
  ...
  "app.currentSessionCopied": "已通过 sd RPC 复制当前会话",
  ...
  "git.gitNotInstalledDesc": "源代码管理功能需要 Git。请前往 https://git-scm.com 安装 Git 后重启 Snacode。",
  ...
  "app.sdCheckFailed": "sd 检测失败：{error}",
  "app.sdCheckPassed": "sd 检测通过：{value}",
  "app.sdPathCleared": "已清除自定义 sd 路径，将恢复自动检测。",
  "app.sdPathSaved": "sd 路径已保存：{path}",
  "app.sdPathValidateFailed": "sd 路径校验失败：{error}",
  "app.preloadMissing": "桌面端预加载 API 未注入，请重新启动 Snacode。",
  ...
  "app.attachImage": "图片",
  "app.attachImageDesc": "从系统选择图片上传并预览",
  ...
  "app.sessionCopied": "已通过 sd RPC 复制会话",
  ...
  "app.shellProxyDisabled": "sd agent 代理已关闭。",
  "app.shellProxySaved": "sd agent 代理设置已保存；新建或重启 agent 后生效。",
  "app.stop": "停止",
  "app.statusIdle": "空闲",
  ...
  "app.windowControls": "Snacode 窗口控制",
  ...
  "agent.trust.message": "此项目包含 sd 配置资源（扩展、skills、设置等）。信任后 sd 将加载并执行这些项目级资源，请确认你信任该项目来源。",
  "agent.trust.project": "项目路径",
  "agent.trust.trustRemember": "信任并记住",
  "agent.trust.trustSession": "本次信任",
  "agent.trust.deny": "不信任",
  "config.nav.raw": "源文件",
  "config.nav.extensions": "SD MCP 库",
  "config.nav.editors": "编辑器",
  "config.nav.im": "飞书机器人",
  "config.nav.logs": "日志",
  "config.nav.skills": "SD Skill 库",
  ...
  "config.providerGuideCompatDevRole": "服务器不支持 developer 角色时设为 false，sd 将使用 system 角色代替",
  ...
  "config.providerGuideNote": "完整的参数说明和示例请参考 sd 官方文档",
  ...
  "config.authGuideDesc": "认证配置用于存储 API Key，Snacode 会自动从 ~/.sd/agent/auth.json 读取。",
  ...
  "config.authGuideStep3": "保存 → sd 启动时自动加载 auth.json 中的认证信息",
  ...
  "config.fetchModelsHintAnthropic": "Anthropic Messages API 不支持 /models 端点。请手动添加 Claude 模型 ID（如 claude-sonnet-4-20250514、claude-3.5-haiku），或查看 sd 官方文档获取完整模型列表。",
  ...
  "config.count.extensions": "{count} 个 MCP",
  "config.count.auth": "{count} 个认证",
  "config.retry.title": "自动重试",
  "config.retry.hint": "只配置 sd Agent 外层重试次数和基础延迟，通过指数退避处理供应商请求失败。修改后需重启 Agent 生效。",
  ...
  "config.count.skills": "{count} 个 SD Skill",
  ...
  "config.label.theme": "主题 (sd)",
  "config.label.language": "语言 (sd)",
  ...
  "config.sessionDir.hint": "仅配置全局 ~/.sd/agent/settings.json 的 sessionDir。相对路径相对项目 cwd（如 .sd/sessions）；留空则使用默认 ~/.sd/agent/sessions/。项目级请改对应项目的 .sd/settings.json。",
  "config.sessionDir.placeholder": "例如 .sd/sessions 或 ~/my-sessions",
  ...
  "config.developerRoleDesc": "API 不支持 developer role 时关闭，sd 将改用 system role 发送系统提示。",
...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "config.recommendedPackages": "推荐 MCP 包",
  "config.recommendedPackagesHint": "以下 MCP 与 Snacode 兼容，可直接安装使用。部分 CLI 特有功能（如 TUI 界面）在桌面端可能不适用。",
  "config.noDescription": "暂无描述",
  "config.searchExtensions": "搜索 GitHub MCP 扩展...",
  "config.sortByStars": "按星数排序",
  "config.sortByUpdated": "按更新时间排序",
  "config.sortByDownloads": "按下载量排序",
  "config.stars": "星数",
  "config.updated": "更新",
  "config.githubSearchNotAvailable": "GitHub 搜索服务暂不可用",
  "config.githubSearchFailed": "GitHub 搜索失败：{error}",
  "config.searchResults": "搜索结果",
  "config.recommended": "推荐",
  "projectResources.title": "项目 SD Skill & MCP & 提示词",
  "projectResources.skillsTab": "SD Skill ({count})",
  "projectResources.extensionsTab": "MCP ({count})",
  "projectResources.promptsTab": "提示词 ({count})",
  "projectResources.emptyPrompts": "该项目暂无项目级提示词。.sd/prompts/ 下的 .md 文件将显示在这里。",
  "projectResources.createSkill": "新建项目 Skill",
  "projectResources.createSkillHint": "Skill 会创建到 .sd/skills/ 下，描述已写入 SKILL.md 的 frontmatter。创建后编辑 SKILL.md 在 ## Usage 下添加具体指令。",
  "projectResources.emptySkills": "该项目暂无 Skill。在上方输入名称和描述后点击添加。",
  "projectResources.emptyExtensions": "该项目暂无 Extension。文件应放在 .sd/extensions/ 下。",
  ...
  "projectResources.extensionsHint": "项目扩展放在 .sd/extensions/ 目录下（.ts 文件或含 index.ts 的子目录）。",
  ...
  "config.headerEmptyHint": "留空时不写入 headers，使用 sd / SDK 运行时默认值",
  "config.location": "位置",
  "config.model": "模型",
  ...
  "config.xhigh": "xhigh",
  "config.xhighOff": "关闭",
  "config.xhighDesc": "声明该模型支持 sd 的 xhigh 档位，并选择发送给上游的 reasoning_effort 值。选择后会自动开启推理和 provider 的 reasoning_effort。",
  "config.inputType": "输入",
  ...
  "config.skillDescriptionMissing": "缺少 description，sd 不会加载该 skill。",
  "config.builtin": "内置",
  ...
  "config.create": "创建",
  "config.noPrompts": "暂无 Prompt 模板。创建后在 sd 中输入 /<名称> 快速使用。",
  ...
  "config.uninstallExtensionBody":
    "确认卸载「{source}」吗？这会执行 sd remove 并从 sd 配置中移除该扩展。",
  ...
  "config.im.guideMethodAStep3": "在 Snacode 填入配置，点击保存后连接",
  ...
  "config.im.guideMethodBStep6": "在「凭证与基础信息」中获取 App ID 和 App Secret，填入 Snacode",
  ...
  "environment.title": "sd 环境检测",
  "environment.checking": "正在检测 sd CLI…",
  "environment.passed": "检测通过",
  "environment.path": "路径",
  "environment.version": "版本",
  "environment.autoClose": "窗口将在 3 秒后自动关闭。",
  "environment.notFoundTitle": "未检测到 sd CLI",
  "environment.notFoundDesc":
    "桌面端通过系统 PATH 和常见包管理器路径自动查找 sd 命令。如果 sd 已安装但未被检测到，可以通过下方参考命令在终端中找到路径后手动指定。",
  "environment.errorDetails": "检测错误详情",
  "environment.installTitle": "还没安装 sd？",
  "environment.installDesc":
    "请按 sd 官方 quickstart 安装并配置 CLI，安装后重新打开应用或点击下方重新检测。",
  "environment.openInstallDocs": "打开安装文档",
  "environment.commandLabel": "命令",
  "environment.customPathTitle": "手动指定 sd 路径",
  "environment.customPathDesc":
    "如果 sd 已安装但桌面端检测不到（如使用了 nvm、pnpm 全局安装、或自定义 mise 数据目录），可运行下方命令，将输出的 sd.cmd 或 sd.exe 路径粘贴到输入框中。",
  ...
  "environment.clearCheckFlagHint": "重置 sd 环境检测标记，下次启动时重新触发检测",
  "environment.checkFlagCleared": "已重置 sd 环境检测标记，重启后将重新检测",
  "environment.stepCli": "检测 CLI",
  "environment.stepInstall": "安装 Agent CLI",
  "environment.stepPath": "确认路径",
  "environment.stepPermission": "验证权限",
  "environment.stepDone": "完成",
  "environment.installCardTitle": "通过 npm 安装 sd",
  "environment.installCardDesc":
    "如果尚未安装 sd，可以在终端逐行执行以下命令安装 Node.js 和 sd CLI（已安装 Node.js 可跳过第一步）。安装完成后重新打开应用。",
  ...
  "environment.installSuccess": "sd CLI 安装成功！请重启应用以生效。",
  ...
  "environment.installRestartHint": "重启后 sd 环境检测将会再次运行。",
  ...
  "feedback.descriptionPlaceholder":
    "例如：点击检测环境后提示未检测到 sd，但命令行里 sd --version 正常。",
  ...
  "feedback.report.sdDetected": "已检测到",
  "feedback.report.sdMissing": "未检测到",
  "feedback.report.sdDesktop": "- Snacode: {value}",
  ...
  "feedback.report.sdStatus": "- sd 检测: {value}",
  "feedback.report.piCommand": "- sd 命令: {value}",
  "feedback.report.sdVersion": "- sd 版本: {value}",
  "feedback.report.piError": "- sd 错误: {value}",
  ...
  "prompt.command.settings.description": "打开 sd 设置",
  ...
  "settings.sdUpdate": "Snacode CLI 更新",
  "settings.sdUpdateDesc": "先检测当前与最新版本，有新版本时才执行更新。",
  "settings.checkSdUpdate": "检查 sd 更新",
  "settings.sdUpdateVersions": "当前：{current} · 最新：{latest}",
  "settings.updatePi": "更新 Agent CLI",
  "settings.sdUpdateDone": "CLI 更新命令已完成",
  "settings.sdUpdateChecked": "CLI 已是最新版本",
  "settings.sdUpdateAvailable": "发现 CLI 新版本",
  "settings.sdUpdateStartupNotice": "检测到 CLI 不是最新版本，部分功能可能与低版本不兼容。请到设置里手动更新 CLI。",
  "settings.sdUpdateFailed": "Agent CLI 更新失败：{error}",
  "settings.disableUpdateCheck": "禁用版本检测",
  "settings.disableUpdateCheckDesc": "开启后不再自动检测 Snacode 和 Agent CLI 的版本更新，设置页中检测按钮也将禁用。",
  ...
  "settings.extensionsUpdating": "正在执行 sd update --extensions --no-approve...",
  "settings.extensionsUpdatingDesc": "更新期间请保持窗口打开，完成后可查看完整输出。",
  "settings.extensionsUpdateResultHint": "已保留 sd CLI 返回的完整输出；如果只显示 Updated packages，说明 CLI 未提供逐项详情，可关闭后刷新确认。",
  ...
  "settings.customSdPath": "自定义 sd 路径",
  "settings.customSdPathValid": "校验通过：{version}",
  "settings.customSdPathHint":
  ...
  "settings.enablePiProxy": "启用 sd agent 代理",
  ...
  "settings.piCliAvailable": "检查 sd CLI 是否可用",
  "settings.piSection": "sd 环境",
  "settings.piSectionDesc": "检测 sd CLI 是否可用，配置自定义路径",
  "settings.sdVersion": "sd 版本",
  "settings.notDetected": "未检测到 sd CLI",
  "settings.checkPi": "检测 sd",
  "settings.customSdPathDesc": "支持带引号、双反斜杠和无扩展名路径；保存前会自动归一化并校验。",
  "settings.piSource.label": "sd 来源",
  "settings.piSource.desc": "选择使用 Windows 本地安装的 sd，还是 WSL 发行版中的 sd。",
  "settings.piSource.windows": "Windows — 使用本地 sd",
  "settings.piSource.wsl": "WSL — 使用 WSL 发行版中的 sd",
  ...
  "settings.wsl.sdDetected": "sd CLI 已安装：{version}",
  "settings.wsl.piNotInstalled": "sd CLI 未安装，请在 WSL 中运行 npm i -g @snacode/sd-coding-agent",
  "settings.sdUpdateSection": "Agent CLI 更新",
  "settings.sdUpdateSectionDesc": "先检测当前与最新版本，有新版本时才执行更新。",
  "settings.sdUpdateStatus": "当前：{current} · 最新：{latest}",
  "settings.sdUpdateSuccess": "Agent CLI 更新成功",
  ...
  "settings.piEnvironment": "sd 环境",
  "settings.sdMissing": "未检测到 sd CLI",
  "settings.piProxy": "sd agent 代理",
  "settings.piProxyDesc": "只注入给新启动的 sd agent 子进程",
  "settings.privacy": "隐私",
  ...
  "settings.testPiProxy": "检测 SD agent 代理",
  ...
  "algs.title": "ALGS 系统",
  "algs.subtitle": "自适应学习生成系统",
  "algs.skillCards": "技能卡片",
  "algs.tasks": "任务中心",
  "algs.loraManagement": "LoRA 管理",
  "algs.addCard": "新建卡片",
  "algs.editCard": "编辑卡片",
  "algs.createCard": "创建卡片",
  "algs.noSkillCards": "暂无技能卡片",
  "algs.createFirstCard": "创建第一张卡片",
  "algs.confirmDelete": "确认删除此卡片？",
  "algs.cardName": "卡片名称",
  "algs.cardNamePlaceholder": "输入卡片名称",
  "algs.taskType": "任务类型",
  "algs.description": "描述",
  "algs.descriptionPlaceholder": "输入描述",
  "algs.systemPrompt": "系统提示词",
  "algs.systemPromptPlaceholder": "输入系统提示词",
  "algs.loraPath": "LoRA 路径",
  "algs.loraPathPlaceholder": "输入 LoRA 文件路径",
  "algs.newTask": "新任务",
  "algs.noTasks": "暂无任务",
  "algs.createFirstTask": "创建第一个任务",
  "algs.selectSkillCard": "选择技能卡片",
  "algs.taskInput": "任务输入",
  "algs.taskInputPlaceholder": "输入任务内容",
  "algs.submitTask": "提交任务",
  "algs.status.pending": "待处理",
  "algs.status.running": "运行中",
  "algs.status.completed": "已完成",
  "algs.status.failed": "失败",
  "algs.status.cancelled": "已取消",
  "algs.downloadLora": "下载 LoRA",
  "algs.newTraining": "新建训练",
  "algs.loraFiles": "LoRA 文件",
  "algs.trainingJobs": "训练任务",
  "algs.noLoraFiles": "暂无 LoRA 文件",
  "algs.downloadFirstLora": "下载第一个 LoRA",
  "algs.confirmDeleteLora": "确认删除此 LoRA？",
  "algs.recentTrainingJobs": "最近训练任务",
  "algs.noTrainingJobs": "暂无训练任务",
  "algs.loraUrl": "LoRA URL",
  "algs.loraUrlPlaceholder": "输入 LoRA 下载链接",
  "algs.download": "下载",
  "algs.taskTypePlaceholder": "输入任务类型",
  "algs.datasetPath": "数据集路径",
  "algs.datasetPathPlaceholder": "输入数据集路径",
  "algs.baseModel": "基础模型",
  "algs.baseModelPlaceholder": "输入基础模型名称",
  "algs.epochs": "训练轮数",
  "algs.batchSize": "批次大小",
  "algs.learningRate": "学习率",
  "algs.startTraining": "开始训练",
} as const;
...
const enUS: Record<TranslationKey, string> = {
  ...
  "mem.card.organizePrompt": "Please help organize the memory store. Read ~/.sd/agent/memory-store.json and analyze its entries: remove duplicates, merge similar items, and drop temporary status notes.\n\nRules:\n1. Output an analysis report only; do not call any tools\n2. Do not ask questions or request confirmation; output the report directly\n3. The user will act on your report in the UI",
  ...
  "app.worktreeRemoveNotFound": "Git worktree not found. It may have been removed outside Snacode.",
  ...
  "app.startAgent": "Start a sd agent",
  "app.emptyTaglineLine1": "There are many agent harnesses",
  "app.emptyTaglineLine2Prefix": "but this one is ",
  "app.emptyTaglineYours": "yours",
  "app.emptySubtitle": "Snacode is a minimal agent harness.\nAdapt Snacode to your workflows, not the other way around.",
  ...
  "app.currentSessionCopied": "Current session copied through sd RPC",
  ...
  "git.gitNotInstalledDesc": "Source control management requires Git. Please install Git from https://git-scm.com and restart Snacode.",
  ...
  "app.agentCreateTimeout":
    "Agent startup timed out. Check whether sd can start normally, then try again.",
  ...
  "app.sdCheckFailed": "sd check failed: {error}",
  "app.sdCheckPassed": "sd check passed: {value}",
  "app.sdPathCleared":
    "Custom sd path cleared. Automatic detection will be used.",
  "app.sdPathSaved": "sd path saved: {path}",
  "app.sdPathValidateFailed": "sd path validation failed: {error}",
  "app.preloadMissing": "Desktop preload API is not available. Restart Snacode.",
  ...
  "app.sdSubagent": "Child session",
  "app.sdSubagentCount": "{count} child sessions",
  "app.proxyAvailable": "{message}; elapsed {elapsed}ms.",
  "app.proxyCheckFailed": "Proxy check failed: {error}",
  "app.proxyChecking": "Checking sd agent proxy...",
  ...
  "app.attachImage": "Image",
  "app.attachImageDesc": "Pick images from system and preview",
  ...
  "app.sessionCopied": "Session copied through sd RPC",
  ...
  "app.shellProxyDisabled": "sd agent proxy disabled.",
  "app.shellProxySaved":
    "sd agent proxy saved. Create or restart agents for it to take effect.",
  "app.stop": "Stop",
  "app.statusIdle": "Idle",
  ...
  "app.windowControls": "Snacode window controls",
  ...
  "code.copy": "Copy Code",
  "config.title": "Snacode Management",
  ...
  "agent.trust.message": "This project contains sd configuration resources (extensions, skills, settings, etc.). Once trusted, sd will load and execute these project-local resources. Make sure you trust this project's source.",
  ...
  "config.nav.extensions": "SD MCP Library",
  "config.nav.editors": "Editors",
  "config.nav.im": "Feishu Bot",
  "config.nav.logs": "Logs",
  "config.nav.skills": "SD Skill Library",
  ...
  "config.providerGuideCompatDevRole": "Set to false when the server does not support developer role; sd will use system role instead",
  ...
  "config.providerGuideNote": "For full parameter details and examples, see sd official docs",
  ...
  "config.authGuideDesc": "Auth config stores API keys. Snacode loads them automatically from ~/.sd/agent/auth.json.",
  ...
  "config.authGuideStep3": "Save → sd loads auth.json credentials automatically on startup",
  ...
  "config.fetchModelsHintAnthropic": "Anthropic Messages API does not support the /models endpoint. Please manually add Claude model IDs (e.g. claude-sonnet-4-20250514, claude-3.5-haiku), or check the sd documentation for the full model list.",
  ...
  "config.loadFailed": "Snacode Config failed to load",
  ...
  "config.renderCrashed": "Snacode Config render error",
  "config.renderCrashedHelp":
  ...
  "config.retry.hint": "Only configures sd Agent-level retry count and base delay with exponential backoff for provider request failures. Restart the Agent for changes to take effect.",
  "config.retry.maxRetries": "Max Retries",
  "config.retry.baseDelayMs": "Base Delay (ms)",
  "config.count.extensions": "{count} MCPs",
  "config.count.models": "{count} models",
  "config.count.providers": "{count} providers",
  "config.count.skills": "{count} SD Skills",
  ...
  "config.label.theme": "Theme (sd)",
  "config.label.language": "Language (sd)",
  ...
  "config.sessionDir.hint": "Edits only the global sessionDir in ~/.sd/agent/settings.json. Relative paths resolve against the project cwd (e.g. .sd/sessions). Leave empty for the default ~/.sd/agent/sessions/. For a single project, set .sd/settings.json in that project instead.",
  "config.sessionDir.placeholder": "e.g. .sd/sessions or ~/my-sessions",
  ...
  "config.developerRoleDesc": "Disable when the API does not support developer role; sd will use system role instead.",
...
"config.emptyExtensions": "No installed extensions.",
  ...
  "editors.hint": "Manage external editors shown in the project menu. Snacode detects them asynchronously on first launch, and paths can be edited manually.",
  ...
  "config.recommendedPackages": "Recommended MCPs",
  "config.recommendedPackagesHint": "These MCPs are compatible with Snacode. Some CLI-specific features (e.g. TUI) may not apply in the desktop version.",
  "config.noDescription": "No description",
  "config.searchExtensions": "Search GitHub MCP extensions...",
  "config.sortByStars": "Sort by stars",
  "config.sortByUpdated": "Sort by updated",
  "config.sortByDownloads": "Sort by downloads",
  "config.stars": "Stars",
  "config.updated": "Updated",
  "config.githubSearchNotAvailable": "GitHub search service unavailable",
  "config.githubSearchFailed": "GitHub search failed: {error}",
  "config.searchResults": "Search Results",
  "config.recommended": "Recommended",
  "projectResources.title": "Project SD Skills && MCPs && Prompts",
  "projectResources.skillsTab": "SD Skills ({count})",
  "projectResources.extensionsTab": "MCPs ({count})",
  "projectResources.promptsTab": "Prompts ({count})",
  "projectResources.emptyPrompts": "No project-level prompts yet. .md files in .sd/prompts/ will appear here.",
  "projectResources.createSkill": "New Project Skill",
  "projectResources.createSkillHint": "The skill will be created under .sd/skills/. The description is saved to the SKILL.md frontmatter. After creation, edit SKILL.md to add your instructions under ## Usage.",
  "projectResources.emptySkills": "No project skills yet. Enter a name and description above to add one.",
  "projectResources.emptyExtensions": "No project extensions yet. Place files under .sd/extensions/.",
  ...
  "projectResources.extensionsHint": "Project extensions live under .sd/extensions/ (.ts files or directories with index.ts).",
  ...
  "config.headerEmptyHint":
    "Leave empty to omit headers and use the sd / SDK runtime default.",
  ...
  "config.xhigh": "xhigh",
  "config.xhighOff": "Off",
  "config.xhighDesc": "Declare that this model supports sd's xhigh level and choose the reasoning_effort value sent upstream. Selecting a value also enables reasoning and provider reasoning_effort.",
  ...
  "config.skillDescriptionMissing":
    "Missing description. sd will not load this skill.",
  ...
  "config.noPrompts": "No prompt templates. After creation, type /<name> in sd to use them.",
  "config.promptNamePlaceholder": "review",
  ...
  "config.uninstallExtensionBody":
    'Uninstall "{source}"? This runs sd remove and removes the extension from sd config.',
  ...
  "config.im.guideMethodAStep3": "Fill in the credentials in Snacode and connect",
  ...
  "config.im.guideMethodBStep6": "Get App ID and App Secret from 'Credentials & Basic Info', fill in Snacode",
  ...
  "environment.title": "sd Environment Check",
  "environment.checking": "Checking sd CLI...",
  "environment.passed": "Check passed",
  "environment.path": "Path",
  "environment.version": "Version",
  "environment.autoClose": "This window will close automatically in 3 seconds.",
  "environment.notFoundTitle": "sd CLI not found",
  "environment.notFoundDesc":
    "The desktop app searches system PATH and common package manager paths for the sd command. If sd is installed but not detected, use the command below to find the path and set it manually.",
  "environment.errorDetails": "Detection error details",
  "environment.installTitle": "sd not installed yet?",
  "environment.installDesc":
    "Follow the official sd quickstart to install and configure the CLI, then reopen the app or run the check again.",
  "environment.openInstallDocs": "Open install docs",
  "environment.commandLabel": "Command",
  "environment.customPathTitle": "Set sd path manually",
  "environment.customPathDesc":
    "If sd is installed but not detected, for example through nvm, pnpm global installs, or a custom mise data directory, run the command below and paste the sd.cmd or sd.exe path here.",
  ...
  "environment.clearCheckFlagHint": "Reset sd environment check flag to re-trigger detection on next startup",
  "environment.checkFlagCleared": "Agent CLI check flag cleared. Detection will run again on restart.",
  "environment.stepCli": "Check CLI",
  "environment.stepInstall": "Install Agent CLI",
  "environment.stepPath": "Confirm path",
  "environment.stepPermission": "Validate access",
  "environment.stepDone": "Done",
  "environment.installCardTitle": "Install sd via npm",
  "environment.installCardDesc":
    "If sd is not installed yet, you can run the commands below in your terminal. Skip the first step if you already have Node.js installed. Restart the app after installation completes.",
  ...
  "environment.installSuccess": "sd CLI installed successfully! Please restart the app.",
  ...
  "environment.installRestartHint": "After restart, the sd environment check will run again.",
  ...
  "feedback.descriptionPlaceholder":
    "For example: Environment check says sd was not found, but sd --version works in the terminal.",
  "feedback.stepsLabel": "Steps to reproduce",
  "feedback.stepsHint": "Write reproducible steps (optional)",
  "feedback.stepsPlaceholder":
    "1. Open the app\n2. Click Feedback in SD Management\n3. ...",
  ...
  "feedback.report.sdDetected": "Detected",
  "feedback.report.sdMissing": "Not detected",
  "feedback.report.sdDesktop": "- Snacode: {value}",
  ...
  "feedback.report.sdStatus": "- sd check: {value}",
  "feedback.report.piCommand": "- sd command: {value}",
  "feedback.report.sdVersion": "- sd version: {value}",
  "feedback.report.piError": "- sd error: {value}",
  ...
  "prompt.command.settings.description": "Open sd settings",
  ...
  "settings.sdUpdate": "Snacode CLI Update",
  "settings.sdUpdateDesc": "Check current/latest versions first, then update only when a newer version exists.",
  "settings.checkSdUpdate": "Check sd Update",
  "settings.sdUpdateVersions": "Current: {current} · Latest: {latest}",
  "settings.updatePi": "Update Agent CLI",
  "settings.sdUpdateDone": "Agent CLI update command completed",
  "settings.sdUpdateChecked": "Agent CLI is already up to date",
  "settings.sdUpdateAvailable": "New Agent CLI version available",
  "settings.sdUpdateStartupNotice": "Agent CLI is not up to date. Some features may be incompatible with older versions. Please update Agent CLI manually in Settings.",
  "settings.sdUpdateFailed": "Agent CLI update failed: {error}",
  "settings.disableUpdateCheck": "Disable Update Check",
  "settings.disableUpdateCheckDesc": "When enabled, stops auto-checking updates for Snacode and Agent CLI. Update buttons in settings will also be disabled.",
  ...
  "settings.extensionsUpdating": "Running sd update --extensions --no-approve...",
  "settings.extensionsUpdatingDesc": "Keep this window open during update. Full output appears here after completion.",
  "settings.extensionsUpdateResultHint": "Full sd CLI output is preserved. If it only says Updated packages, the CLI did not return per-package details; close and refresh to confirm.",
  ...
  "settings.customSdPath": "Custom sd path",
  "settings.customSdPathValid": "Validation passed: {version}",
  "settings.customSdPathHint":
  ...
  "settings.enablePiProxy": "Enable sd agent proxy",
  ...
  "settings.piCliAvailable": "Check whether sd CLI is available",
  "settings.piSection": "sd Environment",
  "settings.piSectionDesc": "Check whether sd CLI is available and configure custom path",
  "settings.sdVersion": "sd Version",
  "settings.notDetected": "sd CLI not found",
  "settings.checkPi": "Check sd",
  "settings.customSdPathDesc": "Supports quoted paths, double backslashes, and extensionless paths. The path is normalized and validated before saving.",
  "settings.piSource.label": "sd Source",
  "settings.piSource.desc": "Choose to use sd from Windows or from a WSL distribution.",
  "settings.piSource.windows": "Windows — use local sd",
  "settings.piSource.wsl": "WSL — use sd from WSL distro",
  ...
  "settings.wsl.sdDetected": "sd CLI installed: {version}",
  "settings.wsl.piNotInstalled": "sd CLI not installed, run npm i -g @snacode/sd-coding-agent in WSL",
  "settings.sdUpdateSection": "Agent CLI Update",
  "settings.sdUpdateSectionDesc": "Check current/latest versions first, then update only when a newer version exists.",
  "settings.sdUpdateStatus": "Current: {current} · Latest: {latest}",
  "settings.sdUpdateSuccess": "Agent CLI updated successfully",
  ...
  "settings.piEnvironment": "sd environment",
  "settings.sdMissing": "sd CLI not found",
  "settings.piProxy": "sd agent proxy",
  "settings.piProxyDesc":
    "Injected only into newly started sd agent child processes",
  ...
  "settings.testPiProxy": "Test SD agent proxy",
  ...
  "settings.restartApp": "Restart Snacode",
  ...
  "settings.restartNotice":
    "Title bar changes take effect after restarting Snacode.",
  ...
  // ===== ALGS System =====
  "algs.title": "ALGS",
  "algs.subtitle": "Adaptive Learning Generation System",
  "algs.skillCards": "Skill Cards",
  "algs.tasks": "Tasks",
  "algs.loraManagement": "LoRA Management",
  "algs.addCard": "Add Card",
  "algs.createCard": "Create Skill Card",
  "algs.editCard": "Edit Skill Card",
  "algs.noSkillCards": "No skill cards yet",
  "algs.createFirstCard": "Create first skill card",
  "algs.cardName": "Card Name",
  "algs.cardNamePlaceholder": "Enter skill card name",
  "algs.taskType": "Task Type",
  "algs.description": "Description",
  "algs.descriptionPlaceholder": "Briefly describe the purpose of this skill card",
  "algs.systemPrompt": "System Prompt",
  "algs.systemPromptPlaceholder": "Enter system prompt content...",
  "algs.loraPath": "LoRA Path",
  "algs.loraPathPlaceholder": "Optional, specify the associated LoRA file path",
  "algs.confirmDelete": "Are you sure you want to delete this skill card?",
  "algs.newTask": "New Task",
  "algs.noTasks": "No tasks yet",
  "algs.createFirstTask": "Create first task",
  "algs.selectSkillCard": "Select Skill Card",
  "algs.taskInput": "Task Input",
  "algs.taskInputPlaceholder": "Enter task content...",
  "algs.submitTask": "Submit Task",
  "algs.downloadLora": "Download LoRA",
  "algs.newTraining": "New Training",
  "algs.loraFiles": "LoRA Files",
  "algs.trainingJobs": "Training Jobs",
  "algs.noLoraFiles": "No LoRA files yet",
  "algs.downloadFirstLora": "Download first LoRA",
  "algs.noTrainingJobs": "No training jobs yet",
  "algs.recentTrainingJobs": "Recent Training Jobs",
  "algs.loraUrl": "LoRA Download URL",
  "algs.loraUrlPlaceholder": "Enter LoRA file download URL",
  "algs.download": "Download",
  "algs.confirmDeleteLora": "Are you sure you want to delete this LoRA file?",
  "algs.datasetPath": "Dataset Path",
  "algs.datasetPathPlaceholder": "Enter training dataset path",
  "algs.baseModel": "Base Model",
  "algs.baseModelPlaceholder": "Enter base model name",
  "algs.epochs": "Epochs",
  "algs.batchSize": "Batch Size",
  "algs.learningRate": "Learning Rate",
  "algs.startTraining": "Start Training",
  "algs.taskTypePlaceholder": "Enter task type",
  "algs.status.pending": "Pending",
  "algs.status.running": "Running",
  "algs.status.completed": "Completed",
  "algs.status.failed": "Failed",
  "algs.status.cancelled": "Cancelled",
};
