...
type DeleteTarget =
	...
	| { kind: "extension"; item: ExtensionSummary }
	| { kind: "prompt"; item: PromptTemplateSummary };
...
export function ProjectResourcesModal(props: {
	...
	// 项目 prompt 编辑器状态
	const [editingProjectPrompt, setEditingProjectPrompt] = useState<PromptTemplateSummary | null>(null);
	...
	/** 重命名项目 Skill */
	const renameSkillConfirm = async (skill: SkillSummary, newName: string) => {
	...
	const openProjectPromptEditor = async (prompt: PromptTemplateSummary) => {
