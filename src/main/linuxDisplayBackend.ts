...
const BACKEND_ENV = "Snacode_LINUX_DISPLAY_BACKEND";
const DISABLE_GPU_ENV = "Snacode_LINUX_DISABLE_GPU";
 ...
 * Wayland with Snacode_LINUX_DISPLAY_BACKEND=wayland or an explicit ozone arg.
 */
