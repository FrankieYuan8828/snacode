...
export class SkillManager {
	...
	async create(input: CreateSkillInput): Promise<SkillSummary> {
	...
	async toggle(skillPath: string, enabled: boolean): Promise<SkillSummary> {
	...
	private async scanLocation(location: SkillLocation): Promise<SkillSummary[]> {
	...
	async rename(skillPath: string, newName: string): Promise<SkillSummary> {
		const skill = await this.findByPath(skillPath);
	...
	private requireLocation(id: SkillLocation["id"]) {
