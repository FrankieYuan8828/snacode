...
const BUILTIN_TEMPLATES: PromptTemplateSummary[] = [
	{
		name: "review",
		path: "builtin://review",
...
export class PromptManager {
	...
	async list(): Promise<PromptTemplateListResult> {
	...
	async create(input: CreatePromptTemplateInput): Promise<PromptTemplateSummary> {
	...
	async rename(oldName: string, newName: string): Promise<PromptTemplateSummary> {
