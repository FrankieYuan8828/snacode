...
const mainSource = readFileSync("src/main/agent/AgentManager.ts", "utf8");
...
test("agent startup writes diagnostics across renderer IPC and sd launch boundaries", () => {
	...
	assert.match(mainSource, /Agent sd process start/);
