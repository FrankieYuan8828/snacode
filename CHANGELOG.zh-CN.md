...
这里记录 Snacode 各版本的重要变化。

## v0.6.6 - 2026-07-24

### 🚀 新功能

- **侧栏品牌区重新设计** — Pi 官方 canvas logo 裁掉棋盘空边，右侧 Snacode 字标使用 Plantin 衬线字体，
...
- **内置浏览器预览**
  ...
  - 支持全屏模式和 PC/手机/平板视口预设，便于不离开 Snacode 快速查看网页
...
### 新增
- Claude 会话导入：项目右键菜单可扫描并导入本地 Claude JSONL 会话，转换为 Snacode 历史会话。
...
### 新增
- 局域网 Web 服务：设置页可启动本机 HTTP 服务，局域网内其他设备可通过电脑 IP 和端口访问 Snacode。
...
- 自定义标题栏布局下，设置和配置页面标题不再与 Snacode 字标重叠。
...
### 修复
- 修复 `.pi`、`.snacode` 等隐藏目录的项目头像只显示点号的问题，现在会跳过前导点和空白。
